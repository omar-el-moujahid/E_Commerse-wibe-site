            ...
            if(isset($_FILES['icone']))
                {
                    ...
                    if(move_uploaded_file($_FILES["icone"]["tmp_name"],'../upload/pro/'. $image .uniqid())){
 ...
 */
 ...
 if(isset($_FILES['icone'])) {
     ...
     // Combine the directory path with the filename and a unique identifier to avoid overwriting existing files
     ...
     if(move_uploaded_file($_FILES["icone"]["tmp_name"],'../upload/pro/'.$name_file)) {
         ...
         echo 'Error uploading file.';
            ...
            $requit2 = "INSERT INTO produit (libelle, prix, discount, id_categorie , icone ,disription) VALUES ('$libelle', '$prix', '$discount', '$categorie' ,'$name_file','$discription')";
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        ...
        <textarea  name="discription"  class="form-control my-3"></textarea>
