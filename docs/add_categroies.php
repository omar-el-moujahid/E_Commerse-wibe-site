...
<div class="container">
    ...
    <?php
     if(isset($_POST["add_Categories"])) {
            if(empty($_POST["Description"]) || empty($_POST["libelle"])){
                ?>
                <div class="alert alert-danger" role="alert"> Please fill in both libelle and description fields.</div>
                ...
                $requit="INSERT INTO categorie (libelle ,description ) VALUES ('$lebelle', '$description')";
